...
class CRM_Core_Payment_MonerisEselect extends CRM_Core_Payment {
  ...
  static function &singleton($mode, &$paymentProcessor) {
    ...
    if (!isset(self::$_singleton[$processorName]) || self::$_singleton[$processorName] === NULL) {
      self::$_singleton[$processorName] = new CRM_Core_Payment_MonerisEselect($mode, $paymentProcessor);
    }
  ...
  function handlePaymentNotification() {
   // require_once 'moneriseselectIPN.php';
    $MonerisEselectIPN = new CRM_Core_Payment_MonerisEselectIPN($this->_mode, $this->_paymentProcessor);
